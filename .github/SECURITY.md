...
[**Report a vulnerability**](https://github.com/frenck/python-pvoutput/security/advisories/new)
...
- Issues in the PVOutput service itself; please report those directly to
  [PVOutput](https://pvoutput.org/).
- Denial-of-service or data-exposure conditions resulting from malformed or
  hostile responses from the PVOutput API. This library assumes the
  remote API endpoint is trusted.

## Scope

This security policy covers the `pvo` Python package published on
[PyPI](https://pypi.org/project/pvo/) and its source code in this
repository.
